-- Create database link from AppDB to UserDB databases.

prompt Dropping existing database link, if any.;
set feedback off
set term off
WHENEVER SQLERROR CONTINUE NONE;
DROP PUBLIC DATABASE LINK vm.userdb;
...
CREATE PUBLIC DATABASE LINK vm.userdb 
...
set term off
SELECT 'OK' as test FROM DUAL@vm.userdb;
